...
| Project | Case Study | GitHub Repo | What It Does |
| --- | --- | --- | --- |
| Confidential Multi-Party Data Collaboration Platform on Google Cloud — **In Progress** | — | — | A GCP-native confidential computing project focused on secure multi-party data collaboration using isolated trust boundaries and attested workloads. |
...
![Cloud security capability stack: cloud platforms, identity and network security, DevSecOps and IaC, detection, governance, and security automation; AI-assisted triage is a learning focus.](assets/cloud-security-capability-stack.svg)
...
![Engineering Approach — evidence-driven cloud security engineering workflow covering design, Infrastructure as Code, deployment, validation, controlled failure, investigation, remediation, revalidation, evidence capture, and cleanup.](assets/engineering-approach-secure-cloud-workflow.png)

## Credentials & Training

![Credentials and Training — certifications, professional credentials, professional certificates, and continuous technical training.](assets/credentials-and-training-infographic.png)
